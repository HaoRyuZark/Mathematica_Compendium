...
This is a code base which consists on different LateX files which explain different math-related topic. 
I have a very repetitive structure for all of my files which is not relevant for the grammar correction, but it
should reamin the same after it. 

Due to time constrains and my lack of knowledge of the english language I found my self having punctuation errors, bad sentence structure, 
no puntuactuations signs after equations where needed, etc. 
...
contents, and then after wards perform the necessary corrections on it.
...
You are not allowed to change the meaning or structure of the LateX-math unless you are correcting its punctuation or other grammar.
