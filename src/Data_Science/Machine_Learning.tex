...
\[
	\mathrm{Precsision} = \frac{TP}{TP + FP}.
\]
...
The \emph{specificity} or false negative rate (FNR) is then given by:

\[
	\mathrm{Specificity} = \frac{FP}{TN + FP}.
\]
...
The higher the curve is the better is our classification model. This can be compared using the area under the curve AOC of different 
curves.
