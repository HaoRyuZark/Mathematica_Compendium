...
\emph{Feature scaling} is a technique used to standardize the range of independent variables or features of data.
...
\[
    \argmin_{C_1, \dots, C_n} \frac{1}{|C_i|} \sum_{i = 1}^{k} \sum_{x_j \in C_i} \| x_j - \mu_i \|^2
\]
...
The metric used can deliver different results.
