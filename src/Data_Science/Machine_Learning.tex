...
Based on the output of the logistic function we classify our data in the respective classes based on a \emph{threshold}. For example, if the output is
greater than 0.5 we classify it as class 1, otherwise as class -1.

For the loss function instead of using the mean squared error we use the \emph{cross entropy} function which is derived using the \emph{maximum likelihood} 
estimation:
