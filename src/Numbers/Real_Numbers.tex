...
Assume \(a < y^2\), because \(a - y < 0\), we know that \(\frac{1}{n} < a - y\) and \( a + \frac{1}{n} < y\). By our assumption 

\[
	\left(a  + \frac{1}{n}\right)^2 = a^2 - \frac{2a}{n} + \frac{1}{n^2} < y
\]

Let us choose \(n\) large enough \(n_0\) such that 
...
\[
	\left(a  + \frac{1}{n_0}\right)^2 = a^2 + (2 - a^2) = y
\]

Thus, \(a + \frac{1}{n} \in T\), but because \(a\) is the supremum this contradiction because our supremum is not the smallest upper-bound. 

For the second case, assume \(a > y\), by applying the same reasoning with \(a - \frac{1}{n}\), we will arrive at a similar contradiction 

Assume \(a^2 > y\), then \(a^2 - y > 0 \implies \frac{1}{n} < a^2 - y, \implies a^2 - \frac{1}{n} < y\)

\[
	\left(a  - \frac{1}{n}\right)^2 = a^2 - \frac{2a}{n} + \frac{1}{n^2} > a^2 - \frac{2a}{n}
\]

Then choose \(n\) such that 

\[
	\frac{2a}{n_0} > a^2 - y \implies a^2 - \frac{2a}{n_0} > y
\]

Then 

\[
	\left(a  - \frac{1}{n_0}\right)^2 > y
\]

But then \(a  - \frac{1}{n_0}\) is an upper bound and this contradicts our assumption.
