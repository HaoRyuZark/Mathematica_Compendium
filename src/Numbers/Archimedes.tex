...
\( n \in \N \). That is, \(x\) is an upper bound for the set \( \N \subset \R\), backed up 
...
is no real number \(x\) which is greater than all natural numbers.
