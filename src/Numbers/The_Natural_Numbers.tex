...
\section{Definition as Sets}

We define for the members of \(\N\) the following properties:
...
\subsection{Definition of the Set of Natural Numbers}
...
\subsection{Proposition 2: \texorpdfstring{\text{For any} \(n \in \N,\ n \ne S(n)\)}{ For any n in N, n!= S (n)}}
...
\section{Definition of Addition in \texorpdfstring{\(\N\)}{}}
...
Suppose \(A \, B\) satisfy our conditions. Fix \(n\) and then let \(M = \{ m \in \N | 
A(n,m) = B(n, m)\}\). Then
