...
In other words, all eigenvalues are contained in a circle with the spectral radius as the center and the sum of the absolute values of the non-diagonal entries of the corresponding row as the radius.
