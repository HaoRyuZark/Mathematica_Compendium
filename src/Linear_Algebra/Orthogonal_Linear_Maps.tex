...
Given two vector spaces \((V, \metric{\centerdot}_V)\) and \((W, \metric{\centerdot}_W)\). Then a map 
...
Note that a rotation is determined by two axis, hence, we get 3 different matrices depending on the two axis we need to rotate.
