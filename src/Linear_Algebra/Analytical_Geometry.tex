...
\begin{align*}
	\langle a - p, q\rangle = 0 &\implies \langle a - \alpha q, q\rangle = 0 \\  
	&\implies \langle a, q\rangle - \alpha \langle q, q\rangle = 0 \quad \text{ by the properties of the inner product}\\
