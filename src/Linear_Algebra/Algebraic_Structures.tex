...
\textbf{Neutral Elements are well-defined:}

We know \(a + 0 = a\). Now let us say \(a + x = 0\). If we then set \(a = 0\) and assume there 
exists some other element with the neutral property we will end up having a neutral plus other neutral will 
give us just the neutral again by definition, else there would be a contradiction.

\[
    0 + x = 0
\]

We conclude that \(x = 0\). By a similar logic we also get well-definiteness for the inverse element.
