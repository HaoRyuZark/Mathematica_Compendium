...
as \(x\) approaches \(a\) from the left or the right.

\[
    \lim_{x \to a^-} f(x) = \pm \infty \quad \text{or} \quad \lim_{x \to a^+} f(x) = \pm \infty
\]

\subsection{How to Find Vertical Asymptotes}
...
\subsection{How to Find Horizontal Asymptotes (Rational Functions)}
...
\section{Oblique (Slant) Asymptotes}
...
\subsection{How to Find Oblique Asymptotes}
