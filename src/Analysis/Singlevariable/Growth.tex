...
\emph{Growth models} are fundamental to understanding population dynamics, resource consumption, and many natural and artificial processes. Two 
primary models of growth are the \textbf{exponential} and the \textbf{logistic} growth models. Each of these has discrete and continuous forms.

\section{Exponential Growth}

\emph{Exponential growth} describes a process that increases at a rate proportional to its current value.
...
\emph{Logistic growth} occurs when a population grows rapidly at first and then slows as it approaches a maximum sustainable size (carrying capacity).

\subsection{Discrete Logistic Growth}
...
\subsection{Continuous Logistic Growth}
