...
To compute we use the abbreviation \emph{ILATE} to find this order to choose \(u\):
...
When dealing with certain integrals it seems that its not possible to common methods, for these cases the 
solution tend to be closely tight to \emph{algebraic manipulation} of the kind adding a clever zero or multiplying by an
elegant one.
