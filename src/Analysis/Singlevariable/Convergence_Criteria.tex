...
In this chapter, we present various tools used to determine whether an infinite series or sequence converges.

\section{Quotient (Ratio) Test}
...
\section{Zero Sequence Criterion}
...
\section{Majorant (Comparison Test)}
...
\section{Leibniz Criterion (Alternating Series Test)}
...
This is a consequence of the \emph{Bolzano-Weierstraß theorem}, which is a form of sequential 
\emph{compactness} in \(\R^n\).

\section{Cauchy Criterion I}
...
\subsection{Cauchy Product Example}
...
\[
    \left(\frac{1}{2}\right) + \left(\frac{1}{3} + \frac{1}{4}\right) + \left(\frac{1}{5} + \cdots + \frac{1}{8}\right) + \cdots > 
    \sum_{k=1}^\infty \frac{1}{2}
\]

The lower bound is a divergent series, hence the \emph{harmonic series} diverges.
