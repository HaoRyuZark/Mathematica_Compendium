...
\section{Telescoping Sums and Partial Fraction Decomposition}

\emph{Telescoping sums} are series where most of the terms cancel out, leaving only a few terms. \emph{Partial fraction decomposition} is a 
technique used to rewrite rational functions as a sum of simpler fractions, which can often lead to telescoping sums.
