...
\[
    \forall \varepsilon > 0 \exists n,m,N_1 \in \Naturals: |a_n - a_m| < \frac{\varepsilon}{2} \text{with } n, m \ge N_1
\]

And  

\[
    \forall \varepsilon > 0 \exists n,m,N_2 \in \Naturals: |a_{n_k} - a| < \frac{\varepsilon}{2} \text{with } n \ge N_2
\]
