...
The \emph{Gamma function} \( \Gamma(x) \) is defined for all \( x > 0 \) by the improper integral:
...
The Gamma distribution with shape \( \alpha > 0 \) and rate \( \beta > 0 \) has the density:
...
Another \emph{extension of the factorial} is given by the function 
