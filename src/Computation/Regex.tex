...
\emph{RegEx} is a system which focuses on the pattern of text by specifying a syntax used to represent an state machine 
for one or more patterns. In the real world it used for example for searching, validating among other operations.
