...
\emph{RegEx} is a system which focuses on the pattern of text by specifying a syntax used to represent a state machine 
for one or more patterns. In the real world, it is used, for example, for searching and validating, among other operations.
...
\section{Meta Characters (Special Characters)}
...
\section{Assertions and Anchors}
