...
\emph{Entropy} is defined as the expected surprise of an event of a random variable \(X\) 
...
\emph{Conditional Entropy} is the expected value of the entropy of a random variable \(X\) given another random variable \(Y\). It is defined as
...
An intuition for this is, given a certain entropy (uncertainty) of \(X\) after you observe \(Y\) you have a new entropy \(H(X | Y)\) and the difference between the two is the mutual information.
