...
As a side note, for the \emph{implication} we can think about it as \emph{if, then}. For the cases 
false, true; and false, false; we call them \emph{vacuously} true. From a false premise, anything can follow.
