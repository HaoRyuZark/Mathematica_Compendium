...
A \emph{Graph} \(G = \langle V, E \rangle \) consists of a finite set of vertices \(V\) and a relation 
...
For a graph \(G\) with vertices \(V = \{v_1, \dots, v_n\}\), we define \emph{the adjacency matrix} \(A = (a_{ij})\) as an 
