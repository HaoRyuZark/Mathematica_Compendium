...
Given two classes \(A\) and \(B\) a \emph{relation} \(R\) is subset of its \emph{Cartesian product} \(R \subseteq A \times B\). 
...
An \emph{equivalence relation} is a relation \(R \subseteq A \times A\) that is \textbf{symmetric}, \textbf{transitive} and \textbf{reflexive}.
...
\subsection{Proof that the Domain And Range are Sets}
...
\subsection{Bijection Functions}
...
\subsection{Lef And Right Inverses}
...
\section{Counting Functions Fom \texorpdfstring{\(A \to B\)}{A to B}}
