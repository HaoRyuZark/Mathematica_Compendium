...
In this chapter, we will cover a variety of trigonometric functions and their properties. \emph{Trigonometry} is widely 
used in different areas of mathematics; hence, this chapter provides the most important facts.

\section{Trigonometric Functions (Triangle Definition)}
...
The \emph{unit circle} is a circle with a radius of 1 centered at the origin. Trigonometric functions like 
...
\subsection{Definitions of the Trigonometric Functions on the Unit Circle}
...
\section{Proof of the Cosine Rule}
