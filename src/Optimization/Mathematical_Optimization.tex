...
normal to them. We also are going to see that both the gradient of \(f\) and the gradient of \(g\) are just scalar version of each other. 
...
In certain cases, this is the way to solve a problem of this topic, hence, here steps to follow.
