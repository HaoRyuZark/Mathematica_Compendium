...
This is a fundamental technique which can help in all kinds of situations.

\section{Common Factorization Techniques}
...
This one is extremly important in the analysis.
...
The \emph{long division for polynomials} works exactly as the division algorithm for real numbers, but we use powers of \(x\) and the scalars of \(\field\) for the 
multiplication step.
