...
\emph{Factorization} is the process of writing a mathematical expression as a product 
...
Another way of factorization is the so-called \emph{long division for polynomials}. This works 
exactly as the division algorithm for real numbers, but we use powers of \(x\) and the scalars of \(\field\) for 
