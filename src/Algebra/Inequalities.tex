...
\emph{Inequalities} play big role in all of mathematics, but specially at the start of real analysis it is 
from major importance to get familiar with them. 
...
Given \(x \in \R, x > -1, x \ne 0\), then for \(n \in \N, n \ge 2\), we have
