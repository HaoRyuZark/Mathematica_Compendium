\chapter{Sum and Product}

These notations are essential for working with sequences, series, and algebraic expressions.
In mathematics, the sum and product notations are compact ways to represent repeated addition and multiplication, respectively.

\section{Sum Notation \texorpdfstring{\(\sum\)}{∑}}
...
\subsection{Power Sums and Their Formulas}
...
\subsection{Derivation of \texorpdfstring{\(\sum_{i=1}^{n} i^2\)}{∑i²}}
...
\section{Product Notation \texorpdfstring{\(\prod\)}{∏}}
