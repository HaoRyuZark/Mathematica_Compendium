...
This object can represent the number of combination in which we can take \(k\) from \(n\) distinct items.
...
\end{itemize}run dnf list installed
...
This is a triangle built by the recursion \(\binom{n + 1}{k + 1} = \binom{n}{k} + \binom{n}{k + 1}\).
