...
formula, the ABC formula, and the Cubic formula. We also derive each of them step by step. There 
will be no mention of the formula for polynomials of degree 4 since it is not really used in worksheets.

\section{The PQ Formula}
...
we use the following formula known as the \emph{Cardano’s formula for depressed cubics}.
...
We first need to transform our cubic polynomial it its depressed cubic using a substitution.
