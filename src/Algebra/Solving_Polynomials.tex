...
we use the following formula known as \emph{Cardano’s formula for depressed cubics}.
...
We first need to transform our cubic polynomial into its depressed cubic using a substitution.
