...
\subsection{Residual Classes and Residual Class Rings}
...
\subsection{Using Modular Arithmetic to Find the n-th Digit of a Large Number}
...
\subsection{Residual Class Ring modulo \texorpdfstring{\(n\)}{}}
