\chapter{Proportionality and the Rule of Three}

This is handled in most schools, but since it tends to be forgotten and can be applied in real life, here it is.

\section{Proportionality}

Two quantities are said to be \emph{proportional} if their ratio remains constant.

\subsection{Direct Proportionality}
...
\subsection{Inverse Proportionality}
...
\section{The Rule of Three (Simple)}
...
\subsection{Direct Rule of Three (Simple)}
...
\subsection{Inverse Rule of Three (Simple)}
...
\section{The Rule of Three (Compound)}
